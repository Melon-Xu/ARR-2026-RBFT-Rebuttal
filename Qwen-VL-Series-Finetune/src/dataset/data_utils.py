...
def get_video_info(video_path, min_pixels, max_pixels, width, height, fps, image_patch_size, nframes=None, return_video_metadata=False):
    # Using this because of process_vision_info function
    # Need to fix this in the future
    content = {
        "type": "video",
    ...
    # Only set fps/nframes when explicitly provided; passing None causes
    # qwen_vl_utils to compute `total_frames / video_fps * fps` which
    # raises TypeError.  nframes takes priority over fps.
